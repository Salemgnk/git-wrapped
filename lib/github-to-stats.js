...
export function githubToStats(input) {
  ...
  if (total === 0) {
    return { user: input.user, year, period, total_commits: 0, empty: true, volume: {}, rhythm: {},
  ...
  return { user: input.user, year, period, total_commits: total, empty: false, volume: vol, rhythm: rhy,
